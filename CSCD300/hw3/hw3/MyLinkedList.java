public class MyLinkedList {
	...
	private MyLinkedList reverse(ListNode node) {
		...
		MyLinkedList newList = reverse(node.next);
		newList.addLast(node.data); // HELPER METHOD, see below
		return newList; // change this line of code as needed
	}
	
	// USER CREATED helper method for reverse(ListNode node) above
